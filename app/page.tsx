  ...
  return (
    <main>
          ...
          <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <Card className="p-6">
              <div className="mb-6 flex items-center justify-between">
                <h3 className="text-2xl font-black text-white">Live Pulse</h3>
              ...
              <div className="grid gap-5">
                {[
                  ...
                  <div key={label as string} className="flex items-center justify-between rounded-xl bg-white/[0.05] p-4">
                    <span className="inline-flex items-center gap-3 text-sm font-bold text-white/62">
                      <Icon className="h-5 w-5 text-primary" />
                      {label as string}
                    </span>
                    <strong className="text-3xl font-black text-white">{value as string}</strong>
                  </div>
                ))}
              </div>
            </Card>
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-5 py-20 lg:grid-cols-[1fr_0.9fr] lg:px-8">
        <div>
          <SectionHeading eyebrow="Recent Posts" title="최신 게시글" href="/community" />
          <div className="grid gap-4">
        ...
        <div>
          <SectionHeading eyebrow="Developer Notes" title="최근 개발일지" />
          <Card className="p-6">
            <p className="text-sm font-black uppercase tracking-[0.16em] text-primary">Dev Log 06</p>
            <h3 className="mt-4 text-3xl font-black leading-tight text-white">플레이어 피드백이 다음 빌드를 바꾸는 방식</h3>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 lg:px-8">
        <SectionHeading eyebrow="Event" title="진행 중 이벤트" href="/event" />
